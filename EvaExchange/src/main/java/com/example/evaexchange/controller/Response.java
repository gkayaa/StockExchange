...
public class Response {
	 ...
	 * 
	 * 
	 * THIS CLASS WAS RETRIEVED BY AN OPEN SOURCE GITHUB REPOSITORY FOR ONLY DEBUGGING PURPOSES
	 * MAKES IT EASIER TO READ THE RESPONSES FOR REQUESTS SENT IN A MORE READABLE WAY
	 * FOR EXAMPLE, IT RETURNS "INTERNAL-SERVER-ERROR" INSTEAD OF CODE:500
	 * AND ALSO, IT PROVIDES CUSTOMIZABLE RESPONSES FOR DIFFERENT BAD REQUESTS SUCH AS - INSUFFICIENT BALANCE, USER PORTFOLIO DOES NOT EXIST etc.
	 * 
	 * 
	 * 
	 */
